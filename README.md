...
[`xirang`](https://github.com/Tape-Out/xirang). The GPU is a submodule at
`third_party/vortex`, on upstream's default branch `master`; nothing in it is modified.

## Status

Planned, capped at fpga-proven by design. Only the submodule is in place; the manifest
and CI arrive with the integration.
